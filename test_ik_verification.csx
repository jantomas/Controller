...
const double TibiaMinRad = -Math.PI / 2;  // -90°
const double TibiaMaxRad = Math.PI / 6;   // 30°

// Forward kinematics
Vector3 ForwardKinematics(double coxa, double femur, double tibia)
{
...
// Inverse kinematics
(double Coxa, double Femur, double Tibia)? InverseKinematics(Vector3 target)
{
